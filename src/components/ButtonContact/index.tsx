...
const ButtonContact = () => {
  ...
  return (
    <section className="fixed right-0 bottom-0 m-5 flex flex-col items-end">
      <div className="mb-5" onClick={() => handleContactButtons(false)}>
        <div
          id="contact1"
      ...
      <div
        ...
        className="bg-green-600 md:h-28 md:w-28 h-20 w-20 rounded-full flex justify-center items-center cursor-pointer"
      >
        <svg
